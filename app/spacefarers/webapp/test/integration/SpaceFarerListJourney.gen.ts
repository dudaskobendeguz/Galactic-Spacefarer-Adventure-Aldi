...
function journey() {
    QUnit.module("SpaceFarerListListReport journey");

    opaTest("Start application", function (Given: Given, _When: When, Then: Then) {
        Given.iStartMyApp();

        Then.onTheSpaceFarerListGenerated.iSeeThisPage();
    });
    ...
    //     When.onTheSpaceFarerListGenerated.onFilterBar().iChangeSearchField("Search Term");
    //     When.onTheSpaceFarerListGenerated.onFilterBar().iExecuteSearch();
    //     Then.onTheSpaceFarerListGenerated.onTable("").iCheckRows();
    // });
    ...
    opaTest("Navigate to ObjectPage", function (_Given: Given, When: When, Then: Then) {
        ...
        When.onTheSpaceFarerListGenerated.onTable("").iPressRow(0);
        Then.onTheSpaceFarerObjectPageGenerated.iSeeThisPage();
